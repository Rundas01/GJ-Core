...
public class ChromeLineMaterials {
    ...
    public static void init() {
        ...
        SodiumChromate = new Material.Builder(4656, gjId("sodium_chromate_vi"))
                .dust()
                .colorAverage()
                .components(Sodium, 2, Chrome, 1, Oxygen, 4)
                .flags(DISABLE_DECOMPOSITION)
                .build();

        SodiumHypochromite = new Material.Builder(4657, gjId("sodium_hypochromite"))
                .dust()
                .colorAverage()
        ...
        ChromeIIISulfate = new Material.Builder(4658, gjId("chrome_iii_sulfate"))
                .dust()
                .colorAverage()
        ...
        ChromeSulfide = new Material.Builder(4659, gjId("chrome_sulfide"))
                .dust()
        ...
        ChromeIIIOxide = new Material.Builder(4660, gjId("chrome_iii_oxide"))
                .dust()
        ...
        SodiumDichromate = new Material.Builder(4661, gjId("sodium_dichromate"))
                .dust()
