package thegreggening.api.widget;
...
public class HeatHatchTankWidget extends Widget implements IIngredientSlot {
    ...
    public HeatHatchTankWidget(IFluidTank fluidTank, int x, int y, int width, int height) {
        super(new Position(x, y), new Size(width, height));
        this.fluidTank = fluidTank;
        this.drawHoveringText = true;
    }

    public HeatHatchTankWidget setClient() {
        this.isClient = true;
    ...
    public HeatHatchTankWidget setHideTooltip(boolean hideTooltip) {
        this.hideTooltip = hideTooltip;
        return this;
    }

    public HeatHatchTankWidget setDrawHoveringText(boolean drawHoveringText) {
        this.drawHoveringText = drawHoveringText;
        return this;
    }

    public HeatHatchTankWidget setAlwaysShowFull(boolean alwaysShowFull) {
        this.alwaysShowFull = alwaysShowFull;
        return this;
    }

    public HeatHatchTankWidget setBackgroundTexture(IGuiTexture... backgroundTexture) {
        this.backgroundTexture = backgroundTexture;
        return this;
    }

    public HeatHatchTankWidget setOverlayTexture(IGuiTexture overlayTexture) {
        this.overlayTexture = overlayTexture;
        return this;
    }

    public HeatHatchTankWidget setFluidRenderOffset(int fluidRenderOffset) {
        this.fluidRenderOffset = fluidRenderOffset;
        return this;
    }

    public HeatHatchTankWidget setContainerClicking(boolean allowClickContainerFilling,
    ...
    private ItemStack fillTankFromStack(@NotNull FluidStack heldFluid, boolean tryFillAll) {
        ...
        // Fluid too cold
        if (heldFluid.getFluid().getTemperature() < Materials.Lava.getFluid().getTemperature()) return ItemStack.EMPTY;
