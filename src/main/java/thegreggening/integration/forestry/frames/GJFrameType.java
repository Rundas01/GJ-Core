...
//
package thegreggening.integration.forestry.frames;
...
public enum GJFrameType implements IBeeModifier {
    ...
    private GJFrameType(String name, int maxDamage, float territory, float mutation, float lifespan, float production,
