package thegreggening.integration.forestry.bees;
...
import thegreggening.integration.forestry.ForestryUtils;
import thegreggening.integration.forestry.bees.mutation.DimensionMutationCondition;
...
import static gregtech.integration.forestry.bees.GTBeeDefinition.OLIVINE;
import static gregtech.integration.forestry.bees.GTBeeDefinition.REDALLOY;
import static thegreggening.api.unification.material.TGSpaceMaterials.*;
import static thegreggening.integration.forestry.ForestryUtils.getTGComb;
import static thegreggening.integration.forestry.item.TGCombType.*;

public enum TGBeeDefinition implements IBeeDefinition {

    // GT Elements
    HYDROGEN(TGBranchDefinition.TG_NOBLEGAS, "Hydrogenia", false, 0xFFFFFF, 0xFF1493,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.HYDROGEN), 0.45f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.NITROGEN), 0.20f);
    ...
    HELIUM(TGBranchDefinition.TG_NOBLEGAS, "Helia", false, 0xFFA9FF, 0xC8B8B4,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.HELIUM), 0.35f);
                beeSpecies.setHumidity(EnumHumidity.NORMAL);
                beeSpecies.setTemperature(EnumTemperature.ICY);
                beeSpecies.setNocturnal();
                beeSpecies.setHasEffect();
    ...
    LITHIUM(TGBranchDefinition.TG_RAREMETAL, "Lithos", false, 0xF0328C, 0xE1DCFF,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.SLAG), 0.30f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.LITHIUM), 0.15f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.SALT), 0.05f);
                beeSpecies.setHumidity(EnumHumidity.NORMAL);
    ...
    BERYLLIUM(TGBranchDefinition.TG_METAL, "Beryllos", false, 0x64B464, 0x006600,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.BERYLLIUM), 0.10f);
            }, template -> {},
            dis -> {
    ...
    BORON(TGBranchDefinition.TG_HALFMETAL, "Bora", false, 0xD2FAD2, 0x006600,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.BORON), 0.10f);
            }, template -> {},
            dis -> {
    ...
    CARBON(TGBranchDefinition.TG_ORGANIC, "Carba", false, 0x141414, 0x006600,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.CARBON), 0.10f);
            }, template -> {},
            dis -> {
    ...
    NITROGEN(TGBranchDefinition.TG_NONMETAL, "Nitrogenium", false, 0xFFC832, 0xA52A2A,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.NITROGEN), 0.45f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.FLUORINE), 0.20f);
                beeSpecies.setHumidity(EnumHumidity.NORMAL);
                beeSpecies.setTemperature(EnumTemperature.ICY);
                beeSpecies.setNocturnal();
                beeSpecies.setHasEffect();
    ...
    OXYGEN(TGBranchDefinition.TG_NONMETAL, "Oxygeni", false, 0xFFFFFF, 0x8F8FFF,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.OXYGEN), 0.45f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.HYDROGEN), 0.20f);
                beeSpecies.setHumidity(EnumHumidity.NORMAL);
                beeSpecies.setTemperature(EnumTemperature.ICY);
                beeSpecies.setNocturnal();
                beeSpecies.setHasEffect();
    ...
    FLUORINE(TGBranchDefinition.TG_HALOGENS, "Fluens", false, 0x86AFF0, 0xFF6D00,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.FLUORINE), 0.45f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.OXYGEN), 0.20f);
                beeSpecies.setHumidity(EnumHumidity.NORMAL);
                beeSpecies.setTemperature(EnumTemperature.ICY);
                beeSpecies.setNocturnal();
                beeSpecies.setHasEffect();
    ...
    NEON(TGBranchDefinition.TG_NOBLEGAS, "Novum", false, 0xFFC826, 0xFF7200,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.NEON), 0.35f);
                beeSpecies.setHumidity(EnumHumidity.NORMAL);
                beeSpecies.setTemperature(EnumTemperature.ICY);
                beeSpecies.setNocturnal();
                beeSpecies.setHasEffect();
    ...
    SODIUM(TGBranchDefinition.TG_ALKALINEMETAL, "Natria", false, 0x000096, 0x006600,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.SODIUM), 0.10f);
            }, template -> {},
            dis -> {
    ...
    MAGNESIUM(TGBranchDefinition.TG_ALKALINEMETAL, "Magnesia", false, 0xFFC8C8, 0x006600,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.MAGNESIUM), 0.10f);
            }, template -> {},
            dis -> {
    ...
    ALUMINIUM(TGBranchDefinition.TG_RAREMETAL, "Alumen", true, 0xB8B8FF, 0xD6D6FF,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.SLAG), 0.30f);
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.ALUMINIUM), 0.15f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.BAUXITE), 0.05f);
    ...
    SILICON(TGBranchDefinition.TG_HALFMETAL, "Silex", false, 0xADA2A7, 0x736675,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(EnumHoneyComb.HONEY), 0.10f);
    ...
    PHOSPHORUS(TGBranchDefinition.TG_ORGANIC, "Phosphorus", false, 0xFFC826, 0xC1C1F6,
            beeSpecies -> {
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.PHOSPHORUS), 0.35f);
                beeSpecies.setTemperature(EnumTemperature.HOT);
                beeSpecies.setNocturnal();
                beeSpecies.setHasEffect();
            },
    ...
    SULFUR(TGBranchDefinition.TG_ORGANIC, "Sulphur", false, 0x1E90FF, 0x3CB4C8,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.SULFUR), 0.70f);
                beeSpecies.setHumidity(EnumHumidity.NORMAL);
                beeSpecies.setTemperature(EnumTemperature.HOT);
            },
    ...
    CHLORINE(TGBranchDefinition.TG_HALOGENS, "Chloros", false, 0x2D8C8C, 0x006600,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.CHLORINE), 0.10f);
            }, template -> {},
            dis -> {
    ...
    ARGON(TGBranchDefinition.TG_NOBLEGAS, "Argon", false, 0x89D9E1, 0xBDA5C2,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.ARGON), 0.35f);
                beeSpecies.setHumidity(EnumHumidity.NORMAL);
                beeSpecies.setTemperature(EnumTemperature.ICY);
                beeSpecies.setNocturnal();
                beeSpecies.setHasEffect();
    ...
    POTASSIUM(TGBranchDefinition.TG_ALKALINEMETAL, "Kalia", false, 0xBEDCFF, 0x006600,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.POTASSIUM), 0.10f);
            }, template -> {},
            dis -> {
    ...
    CALCIUM(TGBranchDefinition.TG_ALKALINEMETAL, "Calcia", false, 0xFFF5DE, 0x006600,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.CALCIUM), 0.10f);
            }, template -> {},
            dis -> {
    ...
    SCANDIUM(TGBranchDefinition.TG_RAREMETAL, "Scandia", false, 0xFFFFFF, 0x006600,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.SCANDIUM), 0.10f);
                beeSpecies.setHasEffect();
            }, template -> {},
            dis -> {
    ...
    TITANIUM(TGBranchDefinition.TG_RAREMETAL, "Titanus", true, 0xCC99FF, 0xDBB8FF,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.SLAG), 0.30f);
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.TITANIUM), 0.15f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.ALMANDINE), 0.05f);
                beeSpecies.setHumidity(EnumHumidity.ARID);
                beeSpecies.setTemperature(EnumTemperature.HOT);
            },
            template -> AlleleHelper.getInstance().set(template, SPEED, EnumAllele.Speed.SLOWER),
    ...
    VANADIUM(TGBranchDefinition.TG_RAREMETAL, "Vanadia", false, 0x323232, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.VANADIUM), 0.10f);
                beeSpecies.setHasEffect();
            }, template -> {},
            dis -> {
    ...
    CHROME(TGBranchDefinition.TG_RAREMETAL, "Chroma", true, 0xEBA1EB, 0xF2C3F2,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.SLAG), 0.30f);
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.CHROME), 0.15f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.MAGNESIUM), 0.05f);
                beeSpecies.setHumidity(EnumHumidity.ARID);
                beeSpecies.setTemperature(EnumTemperature.HOT);
            },
            template -> AlleleHelper.getInstance().set(template, SPEED, EnumAllele.Speed.SLOWER),
    ...
    MANGANESE(TGBranchDefinition.TG_RAREMETAL, "Manganum", true, 0xD5D5D5, 0xAAAAAA,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.SLAG), 0.30f);
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.MANGANESE), 0.15f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.IRON), 0.05f);
                beeSpecies.setHumidity(EnumHumidity.ARID);
                beeSpecies.setTemperature(EnumTemperature.HOT);
            },
            template -> AlleleHelper.getInstance().set(template, SPEED, EnumAllele.Speed.SLOWER),
    ...
    IRON(TGBranchDefinition.TG_METAL, "Ferrum", true, 0xDA9147, 0xDE9C59,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.SLAG), 0.30f);
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.IRON), 0.15f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.TIN), 0.05f);
                beeSpecies.setHumidity(EnumHumidity.NORMAL);
    ...
    COBALT(TGBranchDefinition.TG_RAREMETAL, "Cobalta", false, 0x5050FA, 0x443B44,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.COBALT), 0.10f);
                beeSpecies.setHasEffect();
            }, template -> {},
            dis -> {
    ...
    NICKEL(TGBranchDefinition.TG_METAL, "Nichelium", true, 0x8585AD, 0x8585AD,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.SLAG), 0.30f);
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.NICKEL), 0.15f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.PLATINUM), 0.02f);
                beeSpecies.setHumidity(EnumHumidity.NORMAL);
                beeSpecies.setTemperature(EnumTemperature.NORMAL);
            },
            template -> AlleleHelper.getInstance().set(template, SPEED, EnumAllele.Speed.SLOWER),
    ...
    COPPER(TGBranchDefinition.TG_METAL, "Cuprum", true, 0xFF6600, 0xE65C00,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.SLAG), 0.30f);
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.COPPER), 0.15f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.GOLD), 0.05f);
                beeSpecies.setHumidity(EnumHumidity.NORMAL);
                beeSpecies.setTemperature(EnumTemperature.NORMAL);
            },
            template -> AlleleHelper.getInstance().set(template, SPEED, EnumAllele.Speed.SLOWER),
    ...
    ZINC(TGBranchDefinition.TG_METAL, "Cadmiae", true, 0xF0DEF0, 0xF2E1F2,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.SLAG), 0.30f);
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.ZINC), 0.15f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.GALLIUM), 0.05f);
                beeSpecies.setHumidity(EnumHumidity.NORMAL);
                beeSpecies.setTemperature(EnumTemperature.NORMAL);
            },
            template -> AlleleHelper.getInstance().set(template, SPEED, EnumAllele.Speed.SLOWER),
    ...
    GALLIUM(TGBranchDefinition.TG_RAREMETAL, "Gallia", false, 0xDCDCFF, 0x006600,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.GALLIUM), 0.10f);
                beeSpecies.setHasEffect();
            }, template -> {},
            dis -> {
    ...
    GERMANIUM(TGBranchDefinition.TG_RAREMETAL, "Germania", false, 0x434343, 0x006600,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.GERMANIUM), 0.10f);
                beeSpecies.setHasEffect();
            }, template -> {},
            dis -> {
    ...
    ARSENIC(TGBranchDefinition.TG_HALFMETAL, "Arsenicum", true, 0x736C52, 0x292412,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.SLAG), 0.30f);
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.ARSENIC), 0.15f);
                beeSpecies.setHumidity(EnumHumidity.NORMAL);
    ...
    SELENIUM(TGBranchDefinition.TG_RAREMETAL, "Selenia", false, 0xB6BA6B, 0x006600,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.SELENIUM), 0.10f);
                beeSpecies.setHasEffect();
            }, template -> {},
            dis -> {
    ...
    BROMINE(TGBranchDefinition.TG_HALOGENS, "Bromos", false, 0x500A0A, 0x006600,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.BROMINE), 0.10f);
            }, template -> {},
            dis -> {
    ...
    KRYPTON(TGBranchDefinition.TG_NOBLEGAS, "Kryptos", false, 0x8A97B0, 0x160822,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.KRYPTON), 0.35f);
                beeSpecies.setHumidity(EnumHumidity.NORMAL);
                beeSpecies.setTemperature(EnumTemperature.ICY);
                beeSpecies.setNocturnal();
                beeSpecies.setHasEffect();
    ...
    RUBIDIUM(TGBranchDefinition.TG_ALKALINEMETAL, "Rubidia", false, 0xF01E1E, 0x006600,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.RUBIDIUM), 0.10f);
            }, template -> {},
            dis -> {
    ...
    STRONTIUM(TGBranchDefinition.TG_ALKALINEMETAL, "Strontia", false, 0xC8C8C8, 0x006600,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.STRONTIUM), 0.10f);
                beeSpecies.setHasEffect();
            }, template -> {},
            dis -> {
    ...
    YTTRIUM(TGBranchDefinition.TG_RAREMETAL, "Yttria", false, 0x76524C, 0x006600,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.YTTRIUM), 0.10f);
                beeSpecies.setHasEffect();
            }, template -> {},
            dis -> {
    ...
    ZIRCONIUM(TGBranchDefinition.TG_METAL, "Zirconia", false, 0xC8FFFF, 0x006600,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.ZIRCONIUM), 0.10f);
            }, template -> {},
            dis -> {
    ...
    NIOBIUM(TGBranchDefinition.TG_RAREMETAL, "Niobia", false, 0xBEB4C8, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.NIOBIUM), 0.10f);
                beeSpecies.setHasEffect();
            }, template -> {},
            dis -> {
    ...
    MOLYBDENUM(TGBranchDefinition.TG_RAREMETAL, "Molybdena", false, 0xB4B4DC, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.MOLYBDENUM), 0.10f);
                beeSpecies.setHasEffect();
            }, template -> {},
            dis -> {
    ...
    TECHNETIUM(TGBranchDefinition.TG_RADIOACTIVE, "Technetia", false, 0x545455, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.TECHNETIUM), 0.10f);
            }, template -> {},
            dis -> {
    ...
    RUTHENIUM(TGBranchDefinition.TG_RAREMETAL, "Ruthenia", false, 0x50ACCD, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.RUTHENIUM), 0.10f);
                beeSpecies.setHasEffect();
            }, template -> {},
            dis -> {
    ...
    RHODIUM(TGBranchDefinition.TG_RAREMETAL, "Rhodia", false, 0xDC0C58, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.RHODIUM), 0.10f);
                beeSpecies.setHasEffect();
            }, template -> {},
            dis -> {
    ...
    PALLADIUM(TGBranchDefinition.TG_RAREMETAL, "Palladia", false, 0x808080, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.PALLADIUM), 0.10f);
                beeSpecies.setHasEffect();
            }, template -> {},
            dis -> {
    ...
    SILVER(TGBranchDefinition.TG_METAL, "Argenti", true, 0xC2C2D6, 0xCECEDE,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.SLAG), 0.30f);
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.SILVER), 0.15f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.SULFUR), 0.05f);
                beeSpecies.setHumidity(EnumHumidity.NORMAL);
                beeSpecies.setTemperature(EnumTemperature.COLD);
            },
            template -> AlleleHelper.getInstance().set(template, SPEED, EnumAllele.Speed.SLOWER),
    ...
    CADMIUM(TGBranchDefinition.TG_RAREMETAL, "Cadmia", false, 0x32323C, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.CADMIUM), 0.10f);
                beeSpecies.setHasEffect();
            }, template -> {},
            dis -> {
    ...
    INDIUM(TGBranchDefinition.TG_RAREMETAL, "Indicium", false, 0xFFA9FF, 0x8F5D99,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.INDIUM), 0.05f);
                beeSpecies.setHumidity(EnumHumidity.NORMAL);
                beeSpecies.setTemperature(EnumTemperature.HOT);
                beeSpecies.setHasEffect();
            },
    ...
    TIN(TGBranchDefinition.TG_METAL, "Stannum", true, 0xD4D4D4, 0xDDDDDD,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.SLAG), 0.30f);
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.TIN), 0.15f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.ZINC), 0.05f);
                beeSpecies.setHumidity(EnumHumidity.NORMAL);
                beeSpecies.setTemperature(EnumTemperature.NORMAL);
            },
            template -> AlleleHelper.getInstance().set(template, SPEED, EnumAllele.Speed.SLOWER),
    ...
    ANTIMONY(TGBranchDefinition.TG_METAL, "Antimona", false, 0xDCDCF0, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.ANTIMONY), 0.10f);
            }, template -> {},
            dis -> {
    ...
    TELLURIUM(TGBranchDefinition.TG_HALFMETAL, "Telluria", false, 0xFFFFFF, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.TELLURIUM), 0.10f);
                beeSpecies.setHasEffect();
            }, template -> {},
            dis -> {
    ...
    IODINE(TGBranchDefinition.TG_HALOGENS, "Iodia", false, 0x2C344F, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.IODINE), 0.10f);
            }, template -> {},
            dis -> {
    ...
    XENON(TGBranchDefinition.TG_NOBLEGAS, "Hostis", false, 0x8A97B0, 0x160822,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.XENON), 0.525f);
                beeSpecies.setHumidity(EnumHumidity.NORMAL);
                beeSpecies.setTemperature(EnumTemperature.ICY);
                beeSpecies.setNocturnal();
                beeSpecies.setHasEffect();
    ...
    CAESIUM(TGBranchDefinition.TG_ALKALINEMETAL, "Caesium", false, 0x80620B, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.CAESIUM), 0.10f);
                beeSpecies.setHasEffect();
            }, template -> {},
            dis -> {
    ...
    BARIUM(TGBranchDefinition.TG_ALKALINEMETAL, "Baria", false, 0x83824C, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.BARIUM), 0.10f);
            }, template -> {},
            dis -> {
    ...
    LANTHANUM(TGBranchDefinition.TG_RAREMETAL, "Lanthania", false, 0x5D7575, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.LANTHANUM), 0.10f);
                beeSpecies.setHasEffect();
            }, template -> {},
            dis -> {
    ...
    CERIUM(TGBranchDefinition.TG_RAREMETAL, "Ceria", false, 0x87917D, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.CERIUM), 0.10f);
                beeSpecies.setHasEffect();
            }, template -> {},
            dis -> {
    ...
    PRASEODYMIUM(TGBranchDefinition.TG_RAREMETAL, "Praseodymia", false, 0xCECECE, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.PRASEODYMIUM), 0.10f);
                beeSpecies.setHasEffect();
            }, template -> {},
            dis -> {
    ...
    NEODYMIUM(TGBranchDefinition.TG_RAREMETAL, "Neodymia", false, 0x646464, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.NEODYMIUM), 0.10f);
                beeSpecies.setHasEffect();
            }, template -> {},
            dis -> {
    ...
    PROMETHIUM(TGBranchDefinition.TG_RADIOACTIVE, "Promethia", false, 0xFFFFFF, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.PROMETHIUM), 0.10f);
            }, template -> {},
            dis -> {
    ...
    SAMARIUM(TGBranchDefinition.TG_RAREMETAL, "Samaria", false, 0xFFFFCC, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.SAMARIUM), 0.10f);
                beeSpecies.setHasEffect();
            }, template -> {},
            dis -> {
    ...
    EUROPIUM(TGBranchDefinition.TG_RAREMETAL, "Europia", false, 0x20FFFF, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.EUROPIUM), 0.10f);
                beeSpecies.setHasEffect();
            }, template -> {},
            dis -> {
    ...
    GADOLINIUM(TGBranchDefinition.TG_RAREMETAL, "Gadolinia", false, 0xDDDDFF, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.GADOLINIUM), 0.10f);
                beeSpecies.setHasEffect();
            }, template -> {},
            dis -> {
    ...
    TERBIUM(TGBranchDefinition.TG_RAREMETAL, "Terbia", false, 0xFFFFFF, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.TERBIUM), 0.10f);
                beeSpecies.setHasEffect();
            }, template -> {},
            dis -> {
    ...
    DYSPROSIUM(TGBranchDefinition.TG_RAREMETAL, "Dysprosia", false, 0xFFFFEE, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.DYSPROSIUM), 0.10f);
                beeSpecies.setHasEffect();
            }, template -> {},
            dis -> {
    ...
    HOLMIUM(TGBranchDefinition.TG_RAREMETAL, "Holmia", false, 0xFFFFFF, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.HOLMIUM), 0.10f);
                beeSpecies.setHasEffect();
            }, template -> {},
            dis -> {
    ...
    ERBIUM(TGBranchDefinition.TG_RAREMETAL, "Erbia", false, 0xEEEEEE, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.ERBIUM), 0.10f);
                beeSpecies.setHasEffect();
            }, template -> {},
            dis -> {
    ...
    THULIUM(TGBranchDefinition.TG_RAREMETAL, "Thulia", false, 0xFFFFFF, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.THULIUM), 0.10f);
                beeSpecies.setHasEffect();
            }, template -> {},
            dis -> {
    ...
    YTTERBIUM(TGBranchDefinition.TG_RAREMETAL, "Ytterbia", false, 0xA7A7A7, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.YTTERBIUM), 0.10f);
                beeSpecies.setHasEffect();
            }, template -> {},
            dis -> {
    ...
    LUTETIUM(TGBranchDefinition.TG_RAREMETAL, "Lutetia", false, 0x00AAFF, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.LUTETIUM), 0.10f);
                beeSpecies.setHasEffect();
            }, template -> {},
            dis -> {
    ...
    HAFNIUM(TGBranchDefinition.TG_RAREMETAL, "Hafnia", false, 0x99999A, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.HAFNIUM), 0.10f);
                beeSpecies.setHasEffect();
            }, template -> {},
            dis -> {
    ...
    TANTALUM(TGBranchDefinition.TG_RAREMETAL, "Tantala", false, 0x69B7FF, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.TANTALUM), 0.10f);
            }, template -> {},
            dis -> {
    ...
    TUNGSTEN(TGBranchDefinition.TG_RAREMETAL, "Wolframium", false, 0x5C5C8A, 0x7D7DA1,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.SLAG), 0.30f);
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.TUNGSTEN), 0.15f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.MOLYBDENUM), 0.05f);
                beeSpecies.setHumidity(EnumHumidity.ARID);
                beeSpecies.setTemperature(EnumTemperature.HOT);
            },
            template -> AlleleHelper.getInstance().set(template, SPEED, EnumAllele.Speed.SLOWER),
    ...
    RHENIUM(TGBranchDefinition.TG_RAREMETAL, "Rhenia", false, 0xB6BAC3, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.RHENIUM), 0.10f);
                beeSpecies.setHasEffect();
            }, template -> {},
            dis -> {
    ...
    OSMIUM(TGBranchDefinition.TG_RAREMETAL, "Osmia", false, 0x2B2BDA, 0x8B8B8B,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.SLAG), 0.30f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.OSMIUM), 0.15f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.IRIDIUM), 0.05f);
                beeSpecies.setHumidity(EnumHumidity.ARID);
                beeSpecies.setTemperature(EnumTemperature.COLD);
                beeSpecies.setHasEffect();
            },
    ...
    IRIDIUM(TGBranchDefinition.TG_RAREMETAL, "Iris", false, 0xDADADA, 0xD1D1E0,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.SLAG), 0.30f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.IRIDIUM), 0.15f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.OSMIUM), 0.05f);
                beeSpecies.setHumidity(EnumHumidity.ARID);
    ...
    PLATINUM(TGBranchDefinition.TG_RAREMETAL, "Platina", false, 0xE6E6E6, 0xFFFFCC,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.SLAG), 0.30f);
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.PLATINUM), 0.15f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.IRIDIUM), 0.05f);
                beeSpecies.setHumidity(EnumHumidity.ARID);
                beeSpecies.setTemperature(EnumTemperature.HOT);
            },
    ...
    GOLD(TGBranchDefinition.TG_RAREMETAL, "Aurum", true, 0xEBC633, 0xEDCC47,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.SLAG), 0.30f);
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.GOLD), 0.15f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.NICKEL), 0.05f);
                beeSpecies.setHumidity(EnumHumidity.NORMAL);
                beeSpecies.setTemperature(EnumTemperature.WARM);
            },
            template -> AlleleHelper.getInstance().set(template, SPEED, EnumAllele.Speed.SLOWER),
    ...
    QUICKSILVER(TGBranchDefinition.TG_METAL, "Mercuria", false, 0xE6DCDC, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.QUICKSILVER), 0.10f);
            }, template -> {},
            dis -> {
    ...
    THALLIUM(TGBranchDefinition.TG_RAREMETAL, "Thallia", false, 0xC1C1DE, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.THALLIUM), 0.10f);
                beeSpecies.setHasEffect();
            }, template -> {},
            dis -> {
    ...
    LEAD(TGBranchDefinition.TG_METAL, "Plumbum", true, 0x666699, 0xA3A3CC,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.SLAG), 0.30f);
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.LEAD), 0.15f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.SULFUR), 0.05f);
    ...
    BISMUTH(TGBranchDefinition.TG_RADIOACTIVE, "Bismuthia", false, 0x64A0A0, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.BISMUTH), 0.10f);
            }, template -> {},
            dis -> {
    ...
    POLONIUM(TGBranchDefinition.TG_RADIOACTIVE, "Polonia", false, 0xC9D47E, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.POLONIUM), 0.10f);
            }, template -> {},
            dis -> {
    ...
    ASTATINE(TGBranchDefinition.TG_HALOGENS, "Astatina", false, 0x241A24, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.ASTATINE), 0.10f);
            },
    ...
    RADON(TGBranchDefinition.TG_NOBLEGAS, "Rada", false, 0xFF39FF, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.RADON), 0.10f);
            },
            template -> AlleleHelper.getInstance().set(template, EFFECT, AlleleEffects.effectRadioactive),
            dis -> {
    ...
    FRANCIUM(TGBranchDefinition.TG_ALKALINEMETAL, "Francia", false, 0xAAAAAA, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.FRANCIUM), 0.10f);
            },
            template -> AlleleHelper.getInstance().set(template, EFFECT, AlleleEffects.effectRadioactive),
            dis -> {
    ...
    RADIUM(TGBranchDefinition.TG_ALKALINEMETAL, "Radia", false, 0xFFFFCD, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.RADIUM), 0.10f);
                beeSpecies.setHasEffect();
            },
            template -> AlleleHelper.getInstance().set(template, EFFECT, AlleleEffects.effectRadioactive),
            dis -> {
    ...
    ACTINIUM(TGBranchDefinition.TG_RADIOACTIVE, "Actinia", false, 0xC3D1FF, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.ACTINIUM), 0.10f);
            }, template -> {},
            dis -> {
    ...
    THORIUM(TGBranchDefinition.TG_RADIOACTIVE, "Thorium", false, 0x001E00, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.THORIUM), 0.10f);
                beeSpecies.setHasEffect();
            }, template -> {},
            dis -> {
    ...
    PROTACTINIUM(TGBranchDefinition.TG_RADIOACTIVE, "Protactinium", false, 0xA78B6D, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.PROTACTINIUM), 0.10f);
            }, template -> {},
            dis -> {
    ...
    URANIUM(TGBranchDefinition.TG_RADIOACTIVE, "Ouranos", true, 0x19AF19, 0x169E16,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.SLAG), 0.30f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.URANIUM), 0.15f);
                beeSpecies.setHumidity(EnumHumidity.NORMAL);
                beeSpecies.setTemperature(EnumTemperature.COLD);
                beeSpecies.setNocturnal();
            },
    ...
    NEPTUNIUM(TGBranchDefinition.TG_RADIOACTIVE, "Neptunia", false, 0x284D7B, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.NEPTUNIUM), 0.10f);
            }, template -> {},
            dis -> {
    ...
    PLUTONIUM(TGBranchDefinition.TG_RADIOACTIVE, "Plutos", true, 0x570000, 0x240000,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.SLAG), 0.30f);
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.LEAD), 0.15f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.PLUTONIUM), 0.15f);
                beeSpecies.setHumidity(EnumHumidity.NORMAL);
                beeSpecies.setTemperature(EnumTemperature.ICY);
                beeSpecies.setNocturnal();
            },
    ...
    AMERICIUM(TGBranchDefinition.TG_RADIOACTIVE, "Americia", false, 0x287869, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.AMERICIUM), 0.10f);
            }, template -> {},
            dis -> {
    ...
    CURIUM(TGBranchDefinition.TG_RADIOACTIVE, "Curia", false, 0x7B544E, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.CURIUM), 0.10f);
            }, template -> {},
            dis -> {
    ...
    BERKELIUM(TGBranchDefinition.TG_RADIOACTIVE, "Berkelia", false, 0x645A88, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.BERKELIUM), 0.10f);
            }, template -> {},
            dis -> {
    ...
    CALIFORNIUM(TGBranchDefinition.TG_RADIOACTIVE, "California", false, 0xA85A12, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.CALIFORNIUM), 0.10f);
            }, template -> {},
            dis -> {
    ...
    EINSTEINIUM(TGBranchDefinition.TG_RADIOACTIVE, "Einsteinia", false, 0xCE9F00, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.EINSTEINIUM), 0.10f);
            }, template -> {},
            dis -> {
    ...
    FERMIUM(TGBranchDefinition.TG_RADIOACTIVE, "Fermia", false, 0x984ACF, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.FERMIUM), 0.10f);
            }, template -> {},
            dis -> {
    ...
    MENDELEVIUM(TGBranchDefinition.TG_RADIOACTIVE, "Mendelevia", false, 0x1D4ACF, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.MENDELEVIUM), 0.10f);
            }, template -> {},
            dis -> {
    ...
    NOBELIUM(TGBranchDefinition.TG_RADIOACTIVE, "Nobelia", false, 0x3C7B1F, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.NOBELIUM), 0.10f);
            }, template -> {},
            dis -> {
    ...
    LAWRENCIUM(TGBranchDefinition.TG_RADIOACTIVE, "Lawrencia", false, 0x412B6D, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.LAWRENCIUM), 0.10f);
            }, template -> {},
            dis -> {
    ...
    RUTHERFODIUM(TGBranchDefinition.TG_RADIOACTIVE, "Rutherfordia", false, 0xFFF6A1, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.RUTHERFORDIUM), 0.10f);
            }, template -> {},
            dis -> {
    ...
    DUBNIUM(TGBranchDefinition.TG_RADIOACTIVE, "Dubnia", false, 0xD3FDFF, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.DUBNIUM), 0.10f);
            }, template -> {},
            dis -> {
    ...
    SEABORGIUM(TGBranchDefinition.TG_RADIOACTIVE, "Seaborgia", false, 0x19c5ff, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.SEABORGIUM), 0.10f);
            }, template -> {},
            dis -> {
    ...
    BOHRIUM(TGBranchDefinition.TG_RADIOACTIVE, "Bohria", false, 0xdc57ff, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.BOHRIUM), 0.10f);
            }, template -> {},
            dis -> {
    ...
    HASSIUM(TGBranchDefinition.TG_RADIOACTIVE, "Hassia", false, 0x2d3a9d, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.HASSIUM), 0.10f);
            }, template -> {},
            dis -> {
    ...
    MEITNERIUM(TGBranchDefinition.TG_RADIOACTIVE, "Meitneria", false, 0x2246be, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.MEITNERIUM), 0.10f);
            }, template -> {},
            dis -> {
    ...
    DARMSTADTIUM(TGBranchDefinition.TG_RADIOACTIVE, "Darmstadtia", false, 0x578062, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.DARMSTADTIUM), 0.10f);
            }, template -> {},
            dis -> {
    ...
    ROENTGENIUM(TGBranchDefinition.TG_RADIOACTIVE, "Roentgenia", false, 0xe3fdec, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.ROENTGENIUM), 0.10f);
            }, template -> {},
            dis -> {
    ...
    COPERNICIUM(TGBranchDefinition.TG_RADIOACTIVE, "Copernicia", false, 0xFFFEFF, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.COPERNICIUM), 0.10f);
            }, template -> {},
            dis -> {
    ...
    NIHONIUM(TGBranchDefinition.TG_RADIOACTIVE, "Nihonia", false, 0x08269e, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.NIHONIUM), 0.10f);
            }, template -> {},
            dis -> {
    ...
    FLEROVIUM(TGBranchDefinition.TG_RADIOACTIVE, "Flerovia", false, 0x521973, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.FLEROVIUM), 0.10f);
            }, template -> {},
            dis -> {
    ...
    MOSCOVIUM(TGBranchDefinition.TG_RADIOACTIVE, "Moscovia", false, 0x7854AD, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.MOSCOVIUM), 0.10f);
            }, template -> {},
            dis -> {
    ...
    LIVERMORIUM(TGBranchDefinition.TG_RADIOACTIVE, "Livermoria", false, 0xAAAAAA, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.LIVERMORIUM), 0.10f);
            }, template -> {},
            dis -> {
    ...
    TENNESSINE(TGBranchDefinition.TG_HALOGENS, "Tennessina", false, 0x977FD6, 0xFFBC5E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.TENNESSINE), 0.10f);
            },
            template -> AlleleHelper.getInstance().set(template, EFFECT, AlleleEffects.effectRadioactive),
            dis -> {
    ...
    OGANESSON(TGBranchDefinition.TG_NOBLEGAS, "Oganessa", false, 0x142D64, 0xFAFAFA,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(EnumHoneyComb.HONEY), 0.20f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.OGANESSON), 0.10f);
                beeSpecies.setHasEffect();
            },
            template -> AlleleHelper.getInstance().set(template, EFFECT, AlleleEffects.effectRadioactive),
            dis -> {
    ...
    // Other GT
    CLAY(TGBranchDefinition.TG_ORGANIC, "Lutum", true, 0xC8C8DA, 0x0000FF,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(EnumHoneyComb.HONEY), 0.30f);
    ...
    SLIMEBALL(TGBranchDefinition.TG_ORGANIC, "Bituminipila", true, 0x4E9E55, 0x00FF15,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(EnumHoneyComb.MOSSY), 0.30f);
                beeSpecies.addProduct(new ItemStack(Items.SLIME_BALL), 0.15f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.STICKY), 0.05f);
                beeSpecies.setHumidity(EnumHumidity.DAMP);
                beeSpecies.setTemperature(EnumTemperature.NORMAL);
    ...
    PEAT(TGBranchDefinition.TG_ORGANIC, "Limus", true, 0x906237, 0x58300B,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(EnumHoneyComb.HONEY), 0.15f);
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.COAL), 0.15f);
    ...
    STICKYRESIN(TGBranchDefinition.TG_ORGANIC, "Lenturesinae", true, 0x2E8F5B, 0xDCC289,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(EnumHoneyComb.HONEY), 0.30f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.STICKY), 0.15f);
    ...
    COAL(TGBranchDefinition.TG_ORGANIC, "Carbo", true, 0x666666, 0x525252,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.COAL), 0.30f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.COKE), 0.15f);
                beeSpecies.setHumidity(EnumHumidity.NORMAL);
                beeSpecies.setTemperature(EnumTemperature.NORMAL);
            },
            template -> {
    ...
    OIL(TGBranchDefinition.TG_ORGANIC, "Oleum", true, 0x4C4C4C, 0x333333,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(EnumHoneyComb.HONEY), 0.30f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.OIL), 0.75f);
                beeSpecies.setHumidity(EnumHumidity.DAMP);
                beeSpecies.setTemperature(EnumTemperature.NORMAL);
                beeSpecies.setHasEffect();
            },
    ...
    ASH(TGBranchDefinition.TG_ORGANIC, "Cinis", true, 0x1E1A18, 0xC6C6C6,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(EnumHoneyComb.HONEY), 0.30f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.ASH), 0.15f);
                beeSpecies.setHumidity(EnumHumidity.ARID);
                beeSpecies.setTemperature(EnumTemperature.HOT);
            },
            template -> {
    ...
    APATITE(TGBranchDefinition.TG_ORGANIC, "Stercorat", true, 0x7FCEF5, 0x654525,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(EnumHoneyComb.HONEY), 0.15f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.APATITE), 0.15f);
                beeSpecies.setHumidity(EnumHumidity.NORMAL);
                beeSpecies.setTemperature(EnumTemperature.WARM);
            },
            template -> {
    ...
    BIOMASS(TGBranchDefinition.TG_ORGANIC, "Taeda", true, 0x21E118, 0x17AF0E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(EnumHoneyComb.MOSSY), 0.30f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.BIOMASS), 0.15f);
                beeSpecies.setHumidity(EnumHumidity.NORMAL);
                beeSpecies.setTemperature(EnumTemperature.NORMAL);
            },
            template -> {
    ...
    FERTILIZER(TGBranchDefinition.TG_ORGANIC, "Stercorat", true, 0x7FCEF5, 0x654525,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(EnumHoneyComb.MOSSY), 0.15f);
    ...
    REDSTONE(TGBranchDefinition.TG_GEM, "Rubrumlapis", true, 0x7D0F0F, 0xD11919,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.STONE), 0.30f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.REDSTONE), 0.15f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.RAREEARTH), 0.15f);
                beeSpecies.setHumidity(EnumHumidity.NORMAL);
                beeSpecies.setTemperature(EnumTemperature.NORMAL);
            },
            template -> AlleleHelper.getInstance().set(template, SPEED, EnumAllele.Speed.SLOWER),
    ...
    LAPIS(TGBranchDefinition.TG_GEM, "Lapidi", true, 0x1947D1, 0x476CDA,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.STONE), 0.30f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.LAPIS), 0.15f);
                beeSpecies.setHumidity(EnumHumidity.NORMAL);
                beeSpecies.setTemperature(EnumTemperature.NORMAL);
            },
            template -> AlleleHelper.getInstance().set(template, SPEED, EnumAllele.Speed.SLOWER),
    ...
    CERTUS(TGBranchDefinition.TG_GEM, "Quarzeus", true, 0x57CFFB, 0xBBEEFF,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.STONE), 0.30f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.CERTUS), 0.15f);
                beeSpecies.setHumidity(EnumHumidity.NORMAL);
                beeSpecies.setTemperature(EnumTemperature.NORMAL);
            },
            template -> AlleleHelper.getInstance().set(template, SPEED, EnumAllele.Speed.SLOWER),
    ...
    DIAMOND(TGBranchDefinition.TG_GEM, "Adamas", false, 0xCCFFFF, 0xA3CCCC,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.STONE), 0.30f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.DIAMOND), 0.15f);
                beeSpecies.setHumidity(EnumHumidity.NORMAL);
                beeSpecies.setTemperature(EnumTemperature.HOT);
                beeSpecies.setHasEffect();
            },
    ...
    EMERALD(TGBranchDefinition.TG_GEM, "Smaragdus", false, 0x248F24, 0x2EB82E,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.STONE), 0.30f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.EMERALD), 0.15f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.ALUMINIUM), 0.05f);
                beeSpecies.setHumidity(EnumHumidity.NORMAL);
                beeSpecies.setTemperature(EnumTemperature.COLD);
                beeSpecies.setHasEffect();
            },
    ...
    ELECTROTINE(TGBranchDefinition.TG_RAREMETAL, "Electrum", false, 0x1E90FF, 0x3CB4C8,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.SLAG), 0.30f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.ELECTROTINE), 0.15f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.REDSTONE), 0.05f);
                beeSpecies.setHumidity(EnumHumidity.NORMAL);
                beeSpecies.setTemperature(EnumTemperature.HOT);
            },
            template -> AlleleHelper.getInstance().set(template, SPEED, EnumAllele.Speed.SLOWER),
    ...
    NAQUADAH(TGBranchDefinition.TG_RADIOACTIVE, "Nasquis", false, 0x003300, 0x002400,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.SLAG), 0.30f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.NAQUADAH), 0.15f);
                beeSpecies.setHumidity(EnumHumidity.ARID);
                beeSpecies.setTemperature(EnumTemperature.ICY);
                beeSpecies.setNocturnal();
                beeSpecies.setHasEffect();
    ...
    NAQUADRIA(TGBranchDefinition.TG_RADIOACTIVE, "Nasquidrius", false, 0x000000, 0x002400,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.SLAG), 0.30f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.NAQUADAH), 0.20f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.NAQUADRIA), 0.15f);
                beeSpecies.setHumidity(EnumHumidity.ARID);
                beeSpecies.setTemperature(EnumTemperature.ICY);
                beeSpecies.setNocturnal();
                beeSpecies.setHasEffect();
    ...
    TRINIUM(TGBranchDefinition.TG_RADIOACTIVE, "Trinium", false, 0xB0E0E6, 0xC8C8D2,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.TRINIUM), 0.75f);
                beeSpecies.addSpecialty(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.NAQUADAH), 0.10f);
                beeSpecies.setHumidity(EnumHumidity.NORMAL);
                beeSpecies.setTemperature(EnumTemperature.COLD);
                beeSpecies.setNocturnal();
                beeSpecies.setHasEffect();
    ...
    NEUTRONIUM(TGBranchDefinition.TG_RADIOACTIVE, "Media", false, 0xFFF0F0, 0xFAFAFA,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(gregtech.integration.forestry.bees.GTCombType.NEUTRONIUM), 0.0001f);
                beeSpecies.setHumidity(EnumHumidity.DAMP);
                beeSpecies.setTemperature(EnumTemperature.HELLISH);
                beeSpecies.setHasEffect();
            },
    ...
    // Thaumcraft
    // Primal
    AER(TGBranchDefinition.TG_MAGIC, "Aer", false, 0xffff7e, 0xFF6D00,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.2f);
                beeSpecies.addSpecialty(getTGComb(AIR), 0.1f);
            },
            template -> {},
            dis -> {
    ...
    TERRA(TGBranchDefinition.TG_MAGIC, "Terra", false, 0x56c000, 0xFF6D00,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.2f);
                beeSpecies.addSpecialty(getTGComb(EARTH), 0.1f);
            },
            template -> {},
            dis -> {
                IBeeMutationBuilder mutation = dis.registerMutation(FOREST, MEADOWS, 15);
    ...
    IGNIS(TGBranchDefinition.TG_MAGIC, "Ignis", false, 0xff5a01, 0xFF6D00,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.2f);
                beeSpecies.addSpecialty(getTGComb(FIRE), 0.1f);
            },
            template -> {},
            dis -> {
                IBeeMutationBuilder mutation = dis.registerMutation(FOREST, MEADOWS, 15);
    ...
    AQUA(TGBranchDefinition.TG_MAGIC, "Aqua", false, 0x3cd4fc, 0xFF6D00,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.2f);
                beeSpecies.addSpecialty(getTGComb(WATER), 0.1f);
            },
            template -> {},
            dis -> {
                IBeeMutationBuilder mutation = dis.registerMutation(FOREST, MEADOWS, 15);
    ...
    ORDO(TGBranchDefinition.TG_MAGIC, "Ordo", false, 0xd5d4ec, 0xFF6D00,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.2f);
                beeSpecies.addSpecialty(getTGComb(ORDER), 0.1f);
            },
            template -> {},
            dis -> {
                IBeeMutationBuilder mutation = dis.registerMutation(FOREST, MEADOWS, 15);
    ...
    PERDITIO(TGBranchDefinition.TG_MAGIC, "Perditio", false, 0x404040, 0xFF6D00,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getForestryComb(HONEY), 0.2f);
                beeSpecies.addSpecialty(getTGComb(ENTROPY), 0.1f);
            },
            template -> {},
            dis -> {
                IBeeMutationBuilder mutation = dis.registerMutation(FOREST, MEADOWS, 15);
    ...
    // Composite
    VACUOUS(TGBranchDefinition.TG_MAGIC, "Vacuous", false, 0x888888, 0xFF6D00,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(AIR), 0.25f);
                beeSpecies.addProduct(getTGComb(ENTROPY), 0.25f);
                beeSpecies.addSpecialty(getTGComb(VOID), 0.2f);
            },
            template -> {},
            dis -> {
    ...
    LUX(TGBranchDefinition.TG_MAGIC, "Lux", false, 0xffffc0, 0xFF6D00,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(AIR), 0.25f);
                beeSpecies.addProduct(getTGComb(FIRE), 0.25f);
                beeSpecies.addSpecialty(getTGComb(LIGHT), 0.2f);
            },
            template -> {},
            dis -> {
    ...
    MOTUS(TGBranchDefinition.TG_MAGIC, "Motus", false, 0xcdccf4, 0xFF6D00,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(AIR), 0.25f);
                beeSpecies.addProduct(getTGComb(ORDER), 0.25f);
                beeSpecies.addSpecialty(getTGComb(MOTION), 0.2f);
            },
            template -> {},
            dis -> {
    ...
    GELUM(TGBranchDefinition.TG_MAGIC, "Gelum", false, 0xe1ffff, 0xFF6D00,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(FIRE), 0.25f);
                beeSpecies.addProduct(getTGComb(ENTROPY), 0.25f);
                beeSpecies.addSpecialty(getTGComb(COLD), 0.2f);
            },
            template -> {},
            dis -> {
    ...
    VITREUS(TGBranchDefinition.TG_MAGIC, "Vitreus", false, 0x80ffff, 0xFF6D00,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(AIR), 0.25f);
                beeSpecies.addProduct(getTGComb(EARTH), 0.25f);
                beeSpecies.addSpecialty(getTGComb(CRYSTAL), 0.2f);
            },
            template -> {},
            dis -> {
    ...
    METALLUM(TGBranchDefinition.TG_MAGIC, "Metallum", false, 0xb5b5cd, 0xFF6D00,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(EARTH), 0.25f);
                beeSpecies.addProduct(getTGComb(ORDER), 0.25f);
                beeSpecies.addSpecialty(getTGComb(METAL), 0.2f);
            },
            template -> {},
            dis -> {
    ...
    VICTUS(TGBranchDefinition.TG_MAGIC, "Victus", false, 0xde0005, 0xFF6D00,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(EARTH), 0.25f);
                beeSpecies.addProduct(getTGComb(WATER), 0.25f);
                beeSpecies.addSpecialty(getTGComb(LIFE), 0.2f);
            },
            template -> {},
            dis -> {
    ...
    MORTUUS(TGBranchDefinition.TG_MAGIC, "Mortuus", false, 0x6a0005, 0xFF6D00,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(WATER), 0.25f);
                beeSpecies.addProduct(getTGComb(ENTROPY), 0.25f);
                beeSpecies.addSpecialty(getTGComb(DEATH), 0.2f);
            },
            template -> {},
            dis -> {
    ...
    POTENTIA(TGBranchDefinition.TG_MAGIC, "Potentia", false, 0xc0ffff, 0xFF6D00,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(ORDER), 0.25f);
                beeSpecies.addProduct(getTGComb(FIRE), 0.25f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.ENERGY), 0.2f);
            },
            template -> {},
            dis -> {
    ...
    PERMUTATIO(TGBranchDefinition.TG_MAGIC, "Permutatio", false, 0x578357, 0xFF6D00,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(ORDER), 0.25f);
                beeSpecies.addProduct(getTGComb(ENTROPY), 0.25f);
                beeSpecies.addSpecialty(getTGComb(EXCHANGE), 0.2f);
            },
            template -> {},
            dis -> {
    ...
    PRAECANTATIO(TGBranchDefinition.TG_MAGIC, "Praecantatio", true, 0xcf00ff, 0xFF6D00,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(AIR), 0.5f);
                beeSpecies.addProduct(getTGComb(TGCombType.ENERGY), 0.5f);
                beeSpecies.addSpecialty(getTGComb(MAGIC), 0.25f);
            },
            template -> {},
            dis -> {
    ...
    AURAM(TGBranchDefinition.TG_MAGIC, "Auram", true, 0xffc0ff, 0xFF6D00,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(MAGIC), 0.5f);
                beeSpecies.addProduct(getTGComb(AIR), 0.5f);
                beeSpecies.addSpecialty(getTGComb(AURA), 0.25f);
            },
            template -> {},
            dis -> {
    ...
    ALKIMIA(TGBranchDefinition.TG_MAGIC, "Alkimia", true, 0x23ac9d, 0xFF6D00,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(MAGIC), 0.5f);
                beeSpecies.addProduct(getTGComb(WATER), 0.5f);
                beeSpecies.addSpecialty(getTGComb(ALCHEMY), 0.25f);
            },
            template -> {},
            dis -> {
    ...
    VITIUM(TGBranchDefinition.TG_MAGIC, "Vitium", true, 0x800080, 0xFF6D00,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(MAGIC), 0.5f);
                beeSpecies.addProduct(getTGComb(ENTROPY), 0.5f);
                beeSpecies.addSpecialty(getTGComb(FLUX), 0.25f);
            },
            template -> {},
            dis -> {
    ...
    TENEBRAE(TGBranchDefinition.TG_MAGIC, "Tenebrae", true, 0x222222, 0xFF6D00,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(LIGHT), 0.75f);
                beeSpecies.addProduct(getTGComb(VOID), 0.75f);
                beeSpecies.addSpecialty(getTGComb(DARKNESS), 0.5f);
                beeSpecies.setHasEffect();
            },
            template -> {},
            dis -> {
    ...
    ALIENIS(TGBranchDefinition.TG_MAGIC, "Alienis", true, 0x805080, 0xFF6D00,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(VOID), 0.75f);
                beeSpecies.addProduct(getTGComb(DARKNESS), 0.75f);
                beeSpecies.addSpecialty(getTGComb(ELDRITCH), 0.5f);
                beeSpecies.setHasEffect();
            },
            template -> {},
            dis -> {
    ...
    VOLATUS(TGBranchDefinition.TG_MAGIC, "Volatus", true, 0xe7e7d7, 0xFF6D00,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(AIR), 0.5f);
                beeSpecies.addProduct(getTGComb(MOTION), 0.5f);
                beeSpecies.addSpecialty(getTGComb(FLIGHT), 0.25f);
            },
            template -> {},
            dis -> {
    ...
    HERBA(TGBranchDefinition.TG_MAGIC, "Herba", true, 0x01ac00, 0xFF6D00,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(LIFE), 0.5f);
                beeSpecies.addProduct(getTGComb(EARTH), 0.5f);
                beeSpecies.addSpecialty(getTGComb(PLANT), 0.25f);
            },
            template -> {},
            dis -> {
    ...
    INSTRUMENTUM(TGBranchDefinition.TG_MAGIC, "Instrumentum", true, 0x4040ee, 0xFF6D00,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(METAL), 0.75f);
                beeSpecies.addProduct(getTGComb(TGCombType.ENERGY), 0.75f);
                beeSpecies.addSpecialty(getTGComb(TOOL), 0.5f);
                beeSpecies.setHasEffect();
            },
            template -> {},
            dis -> {
    ...
    FABRICO(TGBranchDefinition.TG_MAGIC, "Fabrico", true, 0x809d80, 0xFF6D00,
            beeSpecies -> {
                beeSpecies.addSpecialty(getTGComb(CRAFT), 0.75f);
                beeSpecies.addProduct(getTGComb(TOOL), 0.75f);
                beeSpecies.addProduct(getTGComb(EXCHANGE), 0.5f);
                beeSpecies.setHasEffect();
            },
            template -> {},
            dis -> {
    ...
    MACHINA(TGBranchDefinition.TG_MAGIC, "Machina", true, 0x8080a0, 0xFF6D00,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(MOTION), 0.75f);
                beeSpecies.addProduct(getTGComb(TOOL), 0.75f);
                beeSpecies.addSpecialty(getTGComb(MECHANISM), 0.5f);
                beeSpecies.setHasEffect();
            },
            template -> {},
            dis -> {
    ...
    VINCULUM(TGBranchDefinition.TG_MAGIC, "Vinculum", true, 0x9a8080, 0xFF6D00,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(MOTION), 0.5f);
                beeSpecies.addProduct(getTGComb(ENTROPY), 0.5f);
                beeSpecies.addSpecialty(getTGComb(TRAP), 0.25f);
            },
            template -> {},
            dis -> {
    ...
    SPIRITUS(TGBranchDefinition.TG_MAGIC, "Spiritus", true, 0xebebfb, 0xFF6D00,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(LIFE), 0.75f);
                beeSpecies.addProduct(getTGComb(DEATH), 0.75f);
                beeSpecies.addSpecialty(getTGComb(SOUL), 0.5f);
                beeSpecies.setHasEffect();
            },
            template -> {},
            dis -> {
    ...
    COGNITIO(TGBranchDefinition.TG_MAGIC, "Cognitio", true, 0xf9967f, 0xFF6D00,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(FIRE), 0.5f);
                beeSpecies.addProduct(getTGComb(SOUL), 0.5f);
                beeSpecies.addSpecialty(getTGComb(MIND), 0.25f);
            },
            template -> {},
            dis -> {
    ...
    SENSUS(TGBranchDefinition.TG_MAGIC, "Sensus", true, 0xc0ffc0, 0xFF6D00,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(SOUL), 0.5f);
                beeSpecies.addProduct(getTGComb(AIR), 0.5f);
                beeSpecies.addSpecialty(getTGComb(SENSES), 0.25f);
            },
            template -> {},
            dis -> {
    ...
    AVERSIO(TGBranchDefinition.TG_MAGIC, "Aversio", true, 0xc05050, 0xFF6D00,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(SOUL), 0.5f);
                beeSpecies.addProduct(getTGComb(ENTROPY), 0.5f);
                beeSpecies.addSpecialty(getTGComb(AVERSION), 0.25f);
            },
            template -> {},
            dis -> {
    ...
    PRAEMUNIO(TGBranchDefinition.TG_MAGIC, "Praemunio", true, 0x00c0c0, 0xFF6D00,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(EARTH), 0.5f);
                beeSpecies.addProduct(getTGComb(SOUL), 0.5f);
                beeSpecies.addSpecialty(getTGComb(PROTECT), 0.25f);
            },
            template -> {},
            dis -> {
    ...
    DESIDERIUM(TGBranchDefinition.TG_MAGIC, "Desiderium", true, 0xe6be44, 0xFF6D00,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(SOUL), 0.75f);
                beeSpecies.addProduct(getTGComb(VOID), 0.75f);
                beeSpecies.addSpecialty(getTGComb(DESIRE), 0.5f);
                beeSpecies.setHasEffect();
            },
            template -> {},
            dis -> {
    ...
    EXANIMIS(TGBranchDefinition.TG_MAGIC, "Exanimis", true, 0x3a4000, 0xFF6D00,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(MOTION), 0.75f);
                beeSpecies.addProduct(getTGComb(DEATH), 0.75f);
                beeSpecies.addSpecialty(getTGComb(UNDEAD), 0.5f);
                beeSpecies.setHasEffect();
            },
            template -> {},
            dis -> {
    ...
    BESTIA(TGBranchDefinition.TG_MAGIC, "Bestia", true, 0x9f6409, 0xFF6D00,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(MOTION), 0.75f);
                beeSpecies.addProduct(getTGComb(LIFE), 0.75f);
                beeSpecies.addSpecialty(getTGComb(BEAST), 0.5f);
                beeSpecies.setHasEffect();
            },
            template -> {},
            dis -> {
    ...
    HUMANUS(TGBranchDefinition.TG_MAGIC, "Humanus", true, 0xffd7c0, 0xFF6D00,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(SOUL), 0.75f);
                beeSpecies.addProduct(getTGComb(LIFE), 0.75f);
                beeSpecies.addSpecialty(getTGComb(MAN), 0.5f);
                beeSpecies.setHasEffect();
            },
            template -> {},
            dis -> {
    ...
    // Glaktikraft
    SPACE(TGBranchDefinition.TG_PLANETS, "Space", false, 0x003366, 0xC0C0C0,
            beeSpecies -> beeSpecies.addProduct(getTGComb(TGCombType.SPACE), 0.75f),
            template -> {},
            dis -> dis.registerMutation(INDUSTRIOUS, IMPERIAL, 10)),
    METEORICIRON(TGBranchDefinition.TG_PLANETS, "MeteoricIron", false, 0x321928, 0x643250,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(TGCombType.SPACE), 0.25f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.METEORICIRON), 0.2f);
            },
            template -> {},
            dis -> {
                IBeeMutationBuilder mutation = dis.registerMutation(SPACE, IRON, 9);
                mutation.addMutationCondition(new DimensionMutationCondition(TGUtil.Dimensions.MOON));
            }),
    LUNA(TGBranchDefinition.TG_PLANETS, "Luna", false, 0x373735, 0x7E7E78,
            beeSpecies -> beeSpecies.addProduct(getTGComb(MOON), 0.75f),
            template -> {},
            dis -> {
                IBeeMutationBuilder mutation = dis.registerMutation(SPACE, CLAY, 4);
                mutation.addMutationCondition(new DimensionMutationCondition(TGUtil.Dimensions.MOON));
            }),
    MARS(TGBranchDefinition.TG_PLANETS, "Mars", false, 0x220D05, 0x3A1505,
            beeSpecies -> beeSpecies.addProduct(getTGComb(TGCombType.MARS), 0.75f),
            template -> {},
            dis -> {
                IBeeMutationBuilder mutation = dis.registerMutation(LUNA, IRON, 20);
                mutation.addMutationCondition(new DimensionMutationCondition(TGUtil.Dimensions.MARS));
            }),
    PHOBOS(TGBranchDefinition.TG_PLANETS, "Phobos", true, 0x220D05, 0x7a5706,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(TGCombType.MARS), 0.5f);
            ...
            dis -> {
                ...
                mutation.addMutationCondition(new DimensionMutationCondition(TGUtil.Dimensions.PHOBOS));
            }),
    DEIMOS(TGBranchDefinition.TG_PLANETS, "Deimos", true, 0x220D05, 0x7a3206,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(TGCombType.MARS), 0.5f);
            ...
            dis -> {
                ...
                mutation.addMutationCondition(new DimensionMutationCondition(TGUtil.Dimensions.DEIMOS));
            }),
    CERES(TGBranchDefinition.TG_PLANETS, "Ceres", true, 0x3ca5b7, 0x1e7267,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(TGCombType.MARS), 0.5f);
            ...
            dis -> {
                ...
                mutation.requireDay();
                mutation.addMutationCondition(new DimensionMutationCondition(TGUtil.Dimensions.CERES));
            }),
    DESH(TGBranchDefinition.TG_PLANETS, "Desh", false, 0x323232, 0x282828,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(TGCombType.SPACE), 0.25f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.DESH), 0.2f);
            },
            template -> {},
            dis -> {
    ...
    MERCURY(TGBranchDefinition.TG_PLANETS, "Mercury", false, 0x4A4033, 0xB5A288,
            beeSpecies -> beeSpecies.addProduct(getTGComb(TGCombType.MERCURY), 0.75f),
            template -> {},
            dis -> {
                IBeeMutationBuilder mutation = dis.registerMutation(METEORICIRON, TUNGSTEN, 25);
                mutation.addMutationCondition(new DimensionMutationCondition(TGUtil.Dimensions.MERCURY));
            }),
    VENUS(TGBranchDefinition.TG_PLANETS, "Venus", false, 0x4A4033, 0xB5A288,
            beeSpecies -> beeSpecies.addProduct(getTGComb(TGCombType.VENUS), 0.75f),
            template -> {},
            dis -> {
                IBeeMutationBuilder mutation = dis.registerMutation(MERCURY, PLATINUM, 5);
                mutation.addMutationCondition(new DimensionMutationCondition(TGUtil.Dimensions.VENUS));
            }),
    JUPITER(TGBranchDefinition.TG_PLANETS, "Jupiter", false, 0x734B2E, 0xD0CBC4,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(TGCombType.JUPITER), 0.35f);
                beeSpecies.setHasEffect();
            },
            template -> {},
            dis -> {
                IBeeMutationBuilder mutation = dis.registerMutation(MARS, DESH, 15);
                mutation.addMutationCondition(new DimensionMutationCondition(TGUtil.Dimensions.ASTEROIDS));
            }),
    EUROPA(TGBranchDefinition.TG_PLANETS, "Europa", true, 0x5982ea, 0x0b36a3,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(TGCombType.JUPITER), 0.5f);
            ...
            dis -> {
                ...
                mutation.addMutationCondition(new DimensionMutationCondition(TGUtil.Dimensions.EUROPA));
            }),
    IO(TGBranchDefinition.TG_PLANETS, "Io", true, 0x734B2E, 0xe5701b,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(TGCombType.JUPITER), 0.5f);
            ...
            dis -> {
                ...
                mutation.addMutationCondition(new DimensionMutationCondition(TGUtil.Dimensions.IO));
            }),
    GANYMEDE(TGBranchDefinition.TG_PLANETS, "Ganymede", true, 0x3d1b10, 0x190c07,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(TGCombType.JUPITER), 0.5f);
            ...
            dis -> {
                ...
                mutation.addMutationCondition(new DimensionMutationCondition(TGUtil.Dimensions.GANYMEDE));
            }),
    CALLISTO(TGBranchDefinition.TG_PLANETS, "Callisto", true, 0x0f333d, 0x0d84a5,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(TGCombType.JUPITER), 0.5f);
            ...
            dis -> {
                ...
                mutation.addMutationCondition(new DimensionMutationCondition(TGUtil.Dimensions.CALLISTO));
            }),
    LEDOX(TGBranchDefinition.TG_PLANETS, "Ledox", false, 0x0000CD, 0x0074FF,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(TGCombType.SPACE), 0.25f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.LEDOX), 0.2f);
            },
            template -> {},
            dis -> {
    ...
    SATURN(TGBranchDefinition.TG_PLANETS, "Saturn", false, 0xD2A472, 0xF8C37B,
            beeSpecies -> beeSpecies.addProduct(getTGComb(TGCombType.SATURN), 0.5f),
            template -> {},
            dis -> {
                IBeeMutationBuilder mutation = dis.registerMutation(JUPITER, LEDOX, 5);
                mutation.addMutationCondition(new DimensionMutationCondition(TGUtil.Dimensions.ASTEROIDS));
            }),
    ENCELADUS(TGBranchDefinition.TG_PLANETS, "Enceladus", true, 0xD2A472, 0x193fa0,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(TGCombType.SATURN), 0.5f);
            ...
            dis -> {
                ...
                mutation.addMutationCondition(new DimensionMutationCondition(TGUtil.Dimensions.ENCELADUS));
            }),
    TITAN(TGBranchDefinition.TG_PLANETS, "Titan", true, 0xa0641b, 0x7c1024,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(TGCombType.SATURN), 0.5f);
            ...
            dis -> {
                ...
                mutation.addMutationCondition(new DimensionMutationCondition(TGUtil.Dimensions.TITAN));
            }),
    URANUS(TGBranchDefinition.TG_PLANETS, "Uranus", false, 0x75C0C9, 0x84D8EC,
            beeSpecies -> beeSpecies.addProduct(getTGComb(TGCombType.URANUS), 0.75f),
            template -> {},
            dis -> {
                IBeeMutationBuilder mutation = dis.registerMutation(SATURN, TRINIUM, 10);
                mutation.addMutationCondition(new DimensionMutationCondition(TGUtil.Dimensions.ASTEROIDS));
            }),
    MIRANDA(TGBranchDefinition.TG_PLANETS, "Miranda", true, 0x75C0C9, 0x0d211c,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(TGCombType.URANUS), 0.5f);
            ...
            dis -> {
                ...
                mutation.addMutationCondition(new DimensionMutationCondition(TGUtil.Dimensions.MIRANDA));
            }),
    OBERON(TGBranchDefinition.TG_PLANETS, "Oberon", true, 0x4A4033, 0xB5A288,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(TGCombType.URANUS), 0.5f);
            ...
            dis -> {
                ...
                mutation.addMutationCondition(new DimensionMutationCondition(TGUtil.Dimensions.OBERON));
            }),
    NEPTUNE(TGBranchDefinition.TG_PLANETS, "Neptune", false, 0x334CFF, 0x576DFF,
            beeSpecies -> beeSpecies.addProduct(getTGComb(TGCombType.NEPTUNE), 0.75f),
            template -> {},
            dis -> {
                IBeeMutationBuilder mutation = dis.registerMutation(URANUS, OBERON, 7);
                mutation.addMutationCondition(new DimensionMutationCondition(TGUtil.Dimensions.ASTEROIDS));
            }),
    PROTEUS(TGBranchDefinition.TG_PLANETS, "Proteus", true, 0x334CFF, 0x592610,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(TGCombType.NEPTUNE), 0.5f);
            ...
            dis -> {
                ...
                mutation.addMutationCondition(new DimensionMutationCondition(TGUtil.Dimensions.PROTEUS));
            }),
    TRITON(TGBranchDefinition.TG_PLANETS, "Triton", true, 0x334CFF, 0x421118,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(TGCombType.NEPTUNE), 0.5f);
            ...
            dis -> {
                ...
                mutation.addMutationCondition(new DimensionMutationCondition(TGUtil.Dimensions.TRITON));
            }),
    PLUTO(TGBranchDefinition.TG_PLANETS, "Pluto", false, 0x34271E, 0x69503D,
            beeSpecies -> beeSpecies.addProduct(getTGComb(TGCombType.PLUTO), 0.75f),
            template -> {},
            dis -> {
                IBeeMutationBuilder mutation = dis.registerMutation(NEPTUNE, PLUTONIUM, 5);
                mutation.addMutationCondition(new DimensionMutationCondition(TGUtil.Dimensions.PLUTO));
            }),
    HAUMEA(TGBranchDefinition.TG_PLANETS, "Haumea", true, 0x1C1413, 0x392B28,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(TGCombType.PLUTO), 0.5f);
            ...
            dis -> {
                ...
                mutation.addMutationCondition(new DimensionMutationCondition(TGUtil.Dimensions.HAUMEA));
            }),
    MAKEMAKE(TGBranchDefinition.TG_PLANETS, "Makemake", true, 0x301811, 0x120A07,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(TGCombType.PLUTO), 0.5f);
            ...
            dis -> {
                ...
                mutation.addMutationCondition(new DimensionMutationCondition(TGUtil.Dimensions.MAKEMAKE));
            }),
    CENTAURI(TGBranchDefinition.TG_PLANETS, "Centauri", false, 0x2F2A14, 0xB06B32,
            beeSpecies -> beeSpecies.addProduct(getTGComb(TGCombType.CENTAURI), 0.75f),
            template -> {},
            dis -> {
                IBeeMutationBuilder mutation = dis.registerMutation(MAKEMAKE, DESH, 3);
                mutation.addMutationCondition(new DimensionMutationCondition(TGUtil.Dimensions.ASTEROIDS));
            }),
    PROXIMA_B(TGBranchDefinition.TG_PLANETS, "ProximaB", false, 0x2F2A14, 0xC17C43,
            beeSpecies -> beeSpecies.addProduct(getTGComb(PROXIMA), 0.5f),
            template -> {},
            dis -> {
                IBeeMutationBuilder mutation = dis.registerMutation(CENTAURI, TUNGSTEN, 5);
                mutation.addMutationCondition(new DimensionMutationCondition(TGUtil.Dimensions.PROXIMA));
            }),
    BARNADA(TGBranchDefinition.TG_PLANETS, "BarnadaC", false, 0x0D5A0D, 0xE6C18D,
            beeSpecies -> beeSpecies.addProduct(getTGComb(TGCombType.BARNADA), 0.75f),
            template -> {},
            dis -> {
                IBeeMutationBuilder mutation = dis.registerMutation(CENTAURI, THORIUM, 3);
                mutation.addMutationCondition(new DimensionMutationCondition(TGUtil.Dimensions.BARNADA));
            }),
    BARNADA_C1(TGBranchDefinition.TG_PLANETS, "BarnadaC1", true, 0x0D5A0D, 0x1e0b49,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(TGCombType.BARNADA), 0.5f);
            ...
            dis -> {
                ...
                mutation.addMutationCondition(new DimensionMutationCondition(TGUtil.Dimensions.BARNADAC1));
            }),
    BARNADA_C2(TGBranchDefinition.TG_PLANETS, "BarnadaC2", true, 0x0D5A0D, 0x1e0b49,
            beeSpecies -> {
                beeSpecies.addProduct(getTGComb(TGCombType.BARNADA), 0.5f);
            ...
            dis -> {
                ...
                mutation.addMutationCondition(new DimensionMutationCondition(TGUtil.Dimensions.BARNADAC2));
            }),
    TAUCETI(TGBranchDefinition.TG_PLANETS, "TauCeti", false, 0xffd7c0, 0xFF6D00,
            beeSpecies -> beeSpecies.addProduct(getTGComb(CETI), 0.75f),
            template -> {},
            dis -> {
                IBeeMutationBuilder mutation = dis.registerMutation(BARNADA, ELECTROTINE, 5);
                // TODO: Dimensions ID
            }),
    CHALOS(TGBranchDefinition.TG_PLANETS, "Chalos", false, 0x0074FF, 0x1EB1FF,
            beeSpecies -> beeSpecies.addProduct(getTGComb(TGCombType.CHALOS), 0.75f),
            template -> {},
            dis -> {
                IBeeMutationBuilder mutation = dis.registerMutation(TAUCETI, HEROIC, 5);
                mutation.addMutationCondition(new DimensionMutationCondition(TGUtil.Dimensions.CHALOS));
            }),
    DIONA(TGBranchDefinition.TG_PLANETS, "Diona", false, 0xDAA520, 0xF26404,
            beeSpecies -> beeSpecies.addProduct(getTGComb(TGCombType.DIONA), 0.75f),
            template -> {},
            dis -> {
                IBeeMutationBuilder mutation = dis.registerMutation(CHALOS, REDALLOY, 5);
                mutation.addMutationCondition(new DimensionMutationCondition(TGUtil.Dimensions.DIONA));
            }),
    FRONOS(TGBranchDefinition.TG_PLANETS, "Fronos", false, 0x00FF00, 0x00D10B,
            beeSpecies -> beeSpecies.addProduct(getTGComb(TGCombType.FRONOS), 0.75f),
            template -> {},
            dis -> {
                IBeeMutationBuilder mutation = dis.registerMutation(DIONA, URANIUM, 5);
                mutation.addMutationCondition(new DimensionMutationCondition(TGUtil.Dimensions.FRONOS));
            }),
    NIBIRU(TGBranchDefinition.TG_PLANETS, "Nibiru", false, 0x228B22, 0x677D68,
            beeSpecies -> beeSpecies.addProduct(getTGComb(TGCombType.NIBIRU), 0.75f),
            template -> {},
            dis -> {
                IBeeMutationBuilder mutation = dis.registerMutation(FRONOS, THORIUM, 5);
                mutation.addMutationCondition(new DimensionMutationCondition(TGUtil.Dimensions.NIBIRU));
            }),
    KOENTUS(TGBranchDefinition.TG_PLANETS, "Koentus", false, 0x3CB371, 0x16856C,
            beeSpecies -> beeSpecies.addProduct(getTGComb(TGCombType.KOENTUS), 0.75f),
            template -> {},
            dis -> {
                IBeeMutationBuilder mutation = dis.registerMutation(NIBIRU, NAQUADRIA, 5);
                mutation.addMutationCondition(new DimensionMutationCondition(TGUtil.Dimensions.KOENTUS));
            }),
    ////Ores
    //Iron
    PYRITE(TGBranchDefinition.TG_ORE, "Pyrite", false, 0x228B22, 0x677D68,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(GTCombType.IRON), 0.75f);
                beeSpecies.addProduct(ForestryUtils.getGTComb(GTCombType.SULFUR), 0.75f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.PYRITE), 0.75f);
            },
            template -> {},
            dis -> {
                IBeeMutationBuilder mutation = dis.registerMutation(IRON, SULFUR, 5);
            }),
    MAGNETITE(TGBranchDefinition.TG_ORE, "Magnetite", false, 0x228B22, 0x677D68,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(GTCombType.IRON), 0.75f);
                beeSpecies.addProduct(ForestryUtils.getGTComb(GTCombType.OXYGEN), 0.75f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.MAGNETITE), 0.75f);
            },
            template -> {},
            dis -> {
                IBeeMutationBuilder mutation = dis.registerMutation(IRON, OXYGEN, 5);
            }),
    TITANOMAGNETITE(TGBranchDefinition.TG_ORE, "Titanomagnetite", false, 0x228B22, 0x677D68,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(GTCombType.TITANIUM), 0.75f);
                beeSpecies.addProduct(ForestryUtils.getTGComb(TGCombType.MAGNETITE), 0.75f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.TITANOMAGNETITE), 0.75f);
            },
            template -> {},
            dis -> {
                IBeeMutationBuilder mutation = dis.registerMutation(MAGNETITE, TITANIUM, 5);
            }),
    BANDED_IRON(TGBranchDefinition.TG_ORE, "Banded Iron", false, 0x228B22, 0x677D68,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(GTCombType.IRON), 0.75f);
                beeSpecies.addProduct(ForestryUtils.getGTComb(GTCombType.OXYGEN), 0.75f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.BANDED_IRON), 0.75f);
            },
            template -> {},
            dis -> {
                IBeeMutationBuilder mutation = dis.registerMutation(MAGNETITE, OXYGEN, 5);
            }),
    LIMONITE(TGBranchDefinition.TG_ORE, "Limonite", false, 0x228B22, 0x677D68,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(GTCombType.IRON), 0.75f);
                beeSpecies.addProduct(ForestryUtils.getGTComb(GTCombType.OXYGEN), 0.75f);
                beeSpecies.addProduct(ForestryUtils.getGTComb(GTCombType.HYDROGEN), 0.75f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.LIMONITE), 0.75f);
            },
            template -> {},
            dis -> {
                IBeeMutationBuilder mutation = dis.registerMutation(BANDED_IRON, ForestryUtil.getSpecies(Mods.ExtraBees, "water"), 5);
            }),
    //Copper
    CHALCOPYRITE(TGBranchDefinition.TG_ORE, "Chalcopyrite", false, 0x228B22, 0x677D68,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(GTCombType.COPPER), 0.75f);
                beeSpecies.addProduct(ForestryUtils.getGTComb(GTCombType.IRON), 0.75f);
                beeSpecies.addProduct(ForestryUtils.getGTComb(GTCombType.SULFUR), 0.75f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.CHALCOPYRITE), 0.75f);
            },
            template -> {},
            dis -> {
                IBeeMutationBuilder mutation = dis.registerMutation(PYRITE, COPPER, 5);
            }),
    CUPRITE(TGBranchDefinition.TG_ORE, "Cuprite", false, 0x228B22, 0x677D68,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(GTCombType.COPPER), 0.75f);
                beeSpecies.addProduct(ForestryUtils.getGTComb(GTCombType.OXYGEN), 0.75f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.CUPRITE), 0.75f);
            },
            template -> {},
            dis -> {
                IBeeMutationBuilder mutation = dis.registerMutation(COPPER, OXYGEN, 5);
            }),
    CHALCOCITE(TGBranchDefinition.TG_ORE, "Chalcocite", false, 0x228B22, 0x677D68,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(GTCombType.COPPER), 0.75f);
                beeSpecies.addProduct(ForestryUtils.getGTComb(GTCombType.SULFUR), 0.75f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.CHALCOCITE), 0.75f);
            },
            template -> {},
            dis -> {
                IBeeMutationBuilder mutation = dis.registerMutation(COPPER, SULFUR, 5);
            }),
    TETRAHEDRITE(TGBranchDefinition.TG_ORE, "Tetrahedrite", false, 0x228B22, 0x677D68,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getTGComb(TGCombType.CHALCOPYRITE), 0.75f);
                beeSpecies.addProduct(ForestryUtils.getTGComb(TGCombType.ANTIMONY), 0.75f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.TETRAHEDRITE), 0.75f);
            },
            template -> {},
            dis -> {
                IBeeMutationBuilder mutation = dis.registerMutation(CHALCOPYRITE, ANTIMONY, 5);
            }),
    BORNITE(TGBranchDefinition.TG_ORE, "Bornite", false, 0x228B22, 0x677D68,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getTGComb(TGCombType.CHALCOPYRITE), 0.75f);
                beeSpecies.addProduct(ForestryUtils.getTGComb(TGCombType.CHALCOCITE), 0.75f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.BORNITE), 0.75f);
            },
            template -> {},
            dis -> {
                IBeeMutationBuilder mutation = dis.registerMutation(CHALCOPYRITE, CHALCOCITE, 5);
            }),
    MALACHITE(TGBranchDefinition.TG_ORE, "Malachite", false, 0x228B22, 0x677D68,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getTGComb(TGCombType.CUPRITE), 0.75f);
                beeSpecies.addProduct(ForestryUtils.getTGComb(TGCombType.CARBON), 0.75f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.MALACHITE), 0.75f);
            },
            template -> {},
            dis -> {
                IBeeMutationBuilder mutation = dis.registerMutation(CUPRITE, CARBON, 5);
            }),
    ENARGITE(TGBranchDefinition.TG_ORE, "Enargite", false, 0x228B22, 0x677D68,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getTGComb(TGCombType.CHALCOCITE), 0.75f);
                beeSpecies.addProduct(ForestryUtils.getGTComb(GTCombType.ARSENIC), 0.75f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.ENARGITE), 0.75f);
            },
            template -> {},
            dis -> {
                IBeeMutationBuilder mutation = dis.registerMutation(CHALCOCITE, ARSENIC, 5);
            }),
    AZURITE(TGBranchDefinition.TG_ORE, "Azurite", false, 0x228B22, 0x677D68,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getTGComb(TGCombType.MALACHITE), 0.75f);
                beeSpecies.addProduct(ForestryUtils.getGTComb(GTCombType.COPPER), 0.75f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.AZURITE), 0.75f);
            },
            template -> {},
            dis -> {
                IBeeMutationBuilder mutation = dis.registerMutation(MALACHITE, COPPER, 5);
            }),
    //Tin
    CASSITERITE(TGBranchDefinition.TG_ORE, "Cassiterite", false, 0x228B22, 0x677D68,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(GTCombType.TIN), 0.75f);
                beeSpecies.addProduct(ForestryUtils.getGTComb(GTCombType.OXYGEN), 0.75f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.CASSITERITE), 0.75f);
            },
            template -> {},
            dis -> {
                IBeeMutationBuilder mutation = dis.registerMutation(TIN, OXYGEN, 5);
            }),
    //Nickel
    GARNIERITE(TGBranchDefinition.TG_ORE, "Garnierite", false, 0x228B22, 0x677D68,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(GTCombType.NICKEL), 0.75f);
                beeSpecies.addProduct(ForestryUtils.getGTComb(GTCombType.OXYGEN), 0.75f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.GARNIERITE), 0.75f);
            },
            template -> {},
            dis -> {
                IBeeMutationBuilder mutation = dis.registerMutation(NICKEL, OXYGEN, 5);
            }),
    PENTLANDITE(TGBranchDefinition.TG_ORE, "Pentlandite", false, 0x228B22, 0x677D68,
            beeSpecies -> {
                beeSpecies.addProduct(ForestryUtils.getGTComb(GTCombType.NICKEL), 0.75f);
                beeSpecies.addProduct(ForestryUtils.getGTComb(GTCombType.SULFUR), 0.75f);
                beeSpecies.addSpecialty(getTGComb(TGCombType.PENTLANDITE), 0.75f);
            },
            template -> {},
            dis -> {
                IBeeMutationBuilder mutation = dis.registerMutation(NICKEL, SULFUR, 5);
            });

    private final TGBranchDefinition branch;
    ...
    private final Consumer<TGBeeDefinition> mutations;
    private IAllele[] template;
    private IBeeGenome genome;
    private final Supplier<Boolean> generationCondition;

    TGBeeDefinition(TGBranchDefinition branch,
                    String binomial,
                    boolean dominant,
                    int primary,
                    int secondary,
                    ...
                    Consumer<TGBeeDefinition> mutations) {
    ...
    public static void initBees() {
        for (TGBeeDefinition bee : values()) {
            bee.init();
        }
        for (TGBeeDefinition bee : values()) {
    ...
    public static void removeMutations() {
        BeeRootAccessor.getBeeMutations().remove(new BeeMutation(OXYGEN.species, HYDROGEN.species, NITROGEN.template, 15));
    }
