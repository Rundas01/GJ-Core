...
public class MetaTileEntityHeatHatch extends FilteredFluidInputHatch {
    ...
    public void addInformation(ItemStack stack, @Nullable World player, @NotNull List<String> tooltip,
                               boolean advanced) {
        tooltip.add(I18n.format("tg.machine.heat_hatch.info", Integer.toString(1000)));
    }
    ...
    public MultiblockAbility<IFluidTank> getAbility() {
        return TGMultiblockAbility.HEAT_HATCH;
    }
    ...
    private class HeatHatchFluidTank extends FilteredFluidTank {
        ...
        public HeatHatchFluidTank(int capacity, MetaTileEntity tileEntity) {
            super(capacity, tileEntity, false,
                    fs -> fs.getFluid().getTemperature() >= Lava.getFluid().getTemperature());
        }
