...
import thegreggening.common.metatileentities.multiblock.electric.MetaTileEntityAdvancedTurbine;

public class MetaTileEntityAdvancedRotorHolder extends MetaTileEntityMultiblockNotifiablePart
    ...
    public MultiblockAbility<IRotorHolder> getAbility() {
        return TGMultiblockAbility.ADVANCED_ROTOR_HOLDER;
    }
