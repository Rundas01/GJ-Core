package gregicality.legacy.api.metatileentity.multiblock;
...
public abstract class MultiMapFuelMultiblockController extends MultiMapMultiblockController {

    public MultiMapFuelMultiblockController(ResourceLocation metaTileEntityId, RecipeMap<?>[] recipeMaps, int tier) {
