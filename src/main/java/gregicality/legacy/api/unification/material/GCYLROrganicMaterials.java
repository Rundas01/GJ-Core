...
public final class GCYLROrganicMaterials {

    private GCYLROrganicMaterials() {}
    ...
    public static void init() {
        ...
        Glucose = new Material.Builder(3211,gcylrId("glucose"))
                .dust()
                .iconSet(ROUGH)
        ...
        Sorbose = new Material.Builder(3212,gcylrId("sorbose"))
                .dust()
                .iconSet(DULL)
                .color(Sugar.getMaterialRGB()+5)
                .components(Carbon,6,Hydrogen,12,Oxygen,6)
        ...
        Fructose = new Material.Builder(3213,gcylrId("fructose"))
                .dust()
                .iconSet(ROUGH)
        ...
        Xylose = new Material.Builder(3214,gcylrId("xylose"))
                .dust()
                .iconSet(ROUGH)
        ...
        Glucosamine = new Material.Builder(3215,gcylrId("glucosamine"))
                .dust()
                .iconSet(FINE)
        ...
        MethylIsobutylCarbinol = new Material.Builder(3216,gcylrId("methyl_isobutyl_carbinol"))
                .fluid()
