...
import static gregicality.legacy.api.unification.material.GCYLROreMaterials.Petalite;
...
import static gregicality.legacy.api.unification.material.materiallines.AntimonyLineMaterials.HighPurityAntimony;
import static gregicality.legacy.api.unification.material.materiallines.CalciumLineMaterials.CalciumSlag;
import static gregicality.legacy.api.unification.material.materiallines.CopperLineMaterials.HighPurityCopper;
import static gregicality.legacy.api.unification.material.materiallines.IronLineMaterials.IronSlag;
import static gregicality.legacy.api.unification.material.materiallines.IronLineMaterials.SodiumFerrateII;
import static gregicality.legacy.api.unification.material.materiallines.LithiumLineMaterials.LithiumOxide;
import static gregicality.legacy.api.unification.material.materiallines.LithiumLineMaterials.LithiumSlag;
...
public class AluminiumLine {
    ...
    private static void additions() {
        ...
        FLOTATION_RECIPES.recipeBuilder()
                .fluidInputs(LazuriteSlag.getFluid(2300))
                .notConsumable(MethylIsobutylCarbinol.getFluid(100))
                .fluidOutputs(AluminiumSlag.getFluid(300),SodiumSlag.getFluid(300),CalciumSlag.getFluid(300))
                .EUt(VA[LV])
                .duration(200)
                .buildAndRegister();

        FLOTATION_RECIPES.recipeBuilder()
                .fluidInputs(SodaliteSlag.getFluid(4600))
                .notConsumable(MethylIsobutylCarbinol.getFluid(100))
                .fluidOutputs(AluminiumSlag.getFluid(600),SodiumSlag.getFluid(800))
                .EUt(VA[LV])
                .duration(200)
                .buildAndRegister();

        FLOTATION_RECIPES.recipeBuilder()
                .fluidInputs(PyropeSlag.getFluid(2000))
                .notConsumable(MethylIsobutylCarbinol.getFluid(100))
                .fluidOutputs(AluminiumSlag.getFluid(200),MagnesiumSlag.getFluid(300))
                .EUt(VA[LV])
                .duration(200)
                .buildAndRegister();

        FLOTATION_RECIPES.recipeBuilder()
                .fluidInputs(BlueTopazSlag.getFluid(1300))
                .notConsumable(MethylIsobutylCarbinol.getFluid(100))
                .fluidOutputs(AluminiumSlag.getFluid(200))
                .EUt(VA[LV])
                .duration(200)
        ...
        FLOTATION_RECIPES.recipeBuilder()
                .fluidInputs(CryoliteSlag.getFluid(1000))
                .notConsumable(MethylIsobutylCarbinol.getFluid(100))
                .fluidOutputs(AluminiumSlag.getFluid(100),SodiumSlag.getFluid(300))
                .EUt(VA[LV])
                .duration(200)
                .buildAndRegister();

        FLOTATION_RECIPES.recipeBuilder()
                .fluidInputs(AlmandineSlag.getFluid(2000))
                .notConsumable(MethylIsobutylCarbinol.getFluid(100))
                .fluidOutputs(AluminiumSlag.getFluid(200),IronSlag.getFluid(300))
                .EUt(VA[LV])
                .duration(200)
                .buildAndRegister();

        FLOTATION_RECIPES.recipeBuilder()
                .fluidInputs(GrossularSlag.getFluid(2000))
                .notConsumable(MethylIsobutylCarbinol.getFluid(100))
                .fluidOutputs(AluminiumSlag.getFluid(200),CalciumSlag.getFluid(300))
                .EUt(VA[LV])
                .duration(200)
                .buildAndRegister();

        FLOTATION_RECIPES.recipeBuilder()
                .fluidInputs(PetaliteSlag.getFluid(1600))
                .notConsumable(MethylIsobutylCarbinol.getFluid(100))
                .fluidOutputs(AluminiumSlag.getFluid(100),LithiumSlag.getFluid(100))
                .EUt(VA[LV])
                .duration(200)
                .buildAndRegister();

        FLOTATION_RECIPES.recipeBuilder()
                .fluidInputs(MicaSlag.getFluid(1900))
                .notConsumable(MethylIsobutylCarbinol.getFluid(100))
                .fluidOutputs(AluminiumSlag.getFluid(300),PotassiumSlag.getFluid(100))
                .EUt(VA[LV])
                .duration(200)
                .buildAndRegister();

        FLOTATION_RECIPES.recipeBuilder()
                .fluidInputs(AluniteSlag.getFluid(2600))
                .notConsumable(MethylIsobutylCarbinol.getFluid(100))
                .fluidOutputs(AluminiumSlag.getFluid(300),PotassiumSlag.getFluid(100))
                .EUt(VA[LV])
                .duration(200)
        ...
        CHEMICAL_RECIPES.recipeBuilder()
                .fluidInputs(SodiumAluminateSolution.getFluid(2000),DistilledWater.getFluid(2000),CarbonDioxide.getFluid(1000))
        ...
        CENTRIFUGE_RECIPES.recipeBuilder()
                ...
                .fluidOutputs(GalliumChloride.getFluid(100),TitaniumTetrachloride.getFluid(100))
                .EUt(VA[MV])
                .duration(300)
                .buildAndRegister();
