...
import gregicality.legacy.integration.forestry.GCYLRCombType;
...
public class GCYLRCombRecipes {
    ...
    public static void initGTCombs() {
        addProcessGT(GCYLRCombType.STELLITE100, new Material[]{GCYMMaterials.Stellite100}, Voltage.LV);
    }

    /**
     * Currently used separately for STEEL, GOLD, MOLYBDENUM, PLUTONIUM
     **/
    private static void addChemicalProcess(GCYLRCombType comb, Material inMaterial, Material outMaterial, Voltage volt) {
     ...
     **/
    private static void addAutoclaveProcess(GCYLRCombType comb, Material material, Voltage volt, int circuitNumber) {
     ...
     **/
    private static void addProcessGT(GCYLRCombType comb, Material[] material, Voltage volt) {
     ...
     **/
    private static void addCentrifugeToMaterial(GCYLRCombType comb, Material[] material, int[] chance, int[] stackSize, Voltage volt, ItemStack beeWax, int waxChance) {
        addCentrifugeToMaterial(comb, material, chance, stackSize, volt, volt.getCentrifugeTime(), beeWax, waxChance);
    }

    private static void addCentrifugeToMaterial(GCYLRCombType comb, Material[] material, int[] chance, int[] stackSize, Voltage volt, int duration, ItemStack beeWax, int waxChance) {
     ...
     **/
    private static void addCentrifugeToItemStack(GCYLRCombType comb, ItemStack[] item, int[] chance, Voltage volt) {
        addCentrifugeToItemStack(comb, item, chance, volt, volt.getCentrifugeTime());
    }

    private static void addCentrifugeToItemStack(GCYLRCombType comb, ItemStack[] item, int[] chance, Voltage volt, int duration) {
    ...
    public static @NotNull ItemStack getCombStack(@NotNull GCYLRCombType type, int amount) {
    ...
    public static @NotNull ItemStack getCombStack(@NotNull GCYLRCombType type) {
