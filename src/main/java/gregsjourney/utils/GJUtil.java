...
public final class GJUtil {
    ...
    public static void setupAquaRegiaOxidations(){
        ...
        aquaRegiaOxidations.put(Arrays.asList(Beryllium, Magnesium, Calcium, Strontium, Barium, Lead, Copper, Silver, Zinc, Cadmium, Mercury, Nickel, Palladium, Platinum, Cobalt, Manganese), 2);
        aquaRegiaOxidations.put(Arrays.asList(Aluminium, Gallium, Indium, Thallium, Scandium, Yttrium, Lanthanum, Gold, Rhodium, Iron, Rhenium, Chrome), 3);
        aquaRegiaOxidations.put(Arrays.asList(Germanium, Tin, Titanium, Zirconium, Hafnium, Iridium, Ruthenium, Osmium), 4);
