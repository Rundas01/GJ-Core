...
public class FilteredFluidInputHatch extends MetaTileEntityMultiblockNotifiablePart implements IMultiblockAbilityPart<IFluidTank> {
    ...
    public FilteredFluidInputHatch(ResourceLocation metaTileEntityId, int tier, int numSlots, IFluidCondition condition) {
    ...
    @Override
    public MultiblockAbility<IFluidTank> getAbility() { return MultiblockAbility.IMPORT_FLUIDS; }
