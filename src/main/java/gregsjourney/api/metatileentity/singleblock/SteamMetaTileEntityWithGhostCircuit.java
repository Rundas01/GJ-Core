package gregsjourney.api.metatileentity.singleblock;
...
public class SteamMetaTileEntityWithGhostCircuit extends SteamMetaTileEntity implements IGhostSlotConfigurable {
    ...
    public SteamMetaTileEntityWithGhostCircuit(ResourceLocation metaTileEntityId, RecipeMap<?> recipeMap, SteamProgressIndicator progressIndicator, ICubeRenderer renderer, boolean isBrickedCasing, boolean isHighPressure) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity iGregTechTileEntity) {
        return new SteamMetaTileEntityWithGhostCircuit(metaTileEntityId, workableHandler.getRecipeMap(), progressIndicator, renderer, isBrickedCasing, isHighPressure);
    }
    ...
    protected TextureArea getCircuitSlotOverlay() {
        return GJTextures.INT_CIRCUIT_OVERLAY_STEAM.get(isHighPressure);
    }
    ...
    protected TextureArea[] getOverlaysForSlot(boolean isOutputs, boolean isFluid) {
        return new TextureArea[] {isFluid ? GJTextures.FLUID_SLOT_STEAM.get(isHighPressure) : GuiTextures.SLOT_STEAM.get(isHighPressure)};
    }
