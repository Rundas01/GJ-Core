...
public class CalciumLineMaterials {
    ...
    public static Material ChlorapatiteSlag;
    ...
    public static void init(){
        ...
        ZeoliteSlag = new Material.Builder(4555,gjId("apatite_slag"))
                .fluid()
        ...
        ChlorapatiteSlag = new Material.Builder(4558,gjId("chlorapatite_slag"))
                .fluid()
                .color(avgColor(Chlorapatite,Steel))
                .build()
                .setFormula("?",true);
        ...
        SulfaticCalciumTailings = new Material.Builder(4566,gjId("sulfatic_calcium_tailings"))
                .fluid()
