...
public class MetaTileEntityCrucible extends RecipeMapMultiblockController {
    public int stoneAmount = 0, smeltingCycle = 0;
    public int smeltingModifier = 0;
    ...
    protected void addDisplayText(List<ITextComponent> textList) {
        MultiblockDisplayText.builder(textList, isStructureFormed())
                ...
                .addCustom(t -> {
                    ITextComponent stoneText = TextComponentUtil.translationWithColor(TextFormatting.WHITE, "gj.machine.crucible.stone_amount", Integer.toString(stoneAmount));
                    t.add(TextComponentUtil.setHover(stoneText));
                    ITextComponent modifierText = TextComponentUtil.translationWithColor(TextFormatting.WHITE, "gj.machine.crucible.modifier", Integer.toString(smeltingModifier));
    ...
    public NBTTagCompound writeToNBT(NBTTagCompound data) {
        ...
        data.setInteger("smeltingCycle",smeltingCycle);
    ...
    public void readFromNBT(NBTTagCompound data) {
        ...
        smeltingCycle = data.getInteger("smeltingCycle");
    ...
    public void setSmeltingModifier(RecipeMapMultiblockController controller){
        if(isStructureFormed()){
            ...
            smeltingModifier = heatProvider.getFluid().getFluid().getTemperature() - Materials.Lava.getFluid().getTemperature() + 1;
        }
    }
    ...
    protected class CrucibleRecipeLogic extends MultiblockRecipeLogic {
        ...
        private void outputLava(RecipeMapMultiblockController controller) {
            ...
            for (int i = 0; i < output.getTanks(); i++) {
                ...
                if(tank.getFluidAmount() < tank.getCapacity() && (tank.getFluidAmount() == 0 || Objects.requireNonNull(tank.getFluid()).getFluid() == Materials.Lava.getFluid()) && smeltingModifier > 0){
