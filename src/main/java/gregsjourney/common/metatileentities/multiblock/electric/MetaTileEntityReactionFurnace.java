...
import static gregsjourney.common.recipe.GJRecipeMaps.REACTION_FURNACE_RECIPES;
...
public class MetaTileEntityReactionFurnace extends RecipeMapMultiblockController {
    ...
    public String[] getDescription() {
        return new String[] { I18n.format("gj.multiblock.reaction_furnace.description") };
    }
}
