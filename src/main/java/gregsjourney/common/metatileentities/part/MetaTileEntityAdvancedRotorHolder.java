...
public class MetaTileEntityAdvancedRotorHolder extends MetaTileEntityMultiblockNotifiablePart implements IMultiblockAbilityPart<IRotorHolder>, IRotorHolder {
    ...
    @Override
    public MultiblockAbility<IRotorHolder> getAbility() { return GJMultiblockAbility.ADVANCED_ROTOR_HOLDER; }
    ...
    public void update() {
        ...
        MetaTileEntityAdvancedTurbine controller = (MetaTileEntityAdvancedTurbine) getController();
