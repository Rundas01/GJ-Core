...
import static gregsjourney.api.recipe.GJRecipeMaps.ADVANCED_COMBUSTION_FUELS;
import static gregsjourney.api.recipe.GJRecipeMaps.ADVANCED_STEAM_FUELS;
...
public class FuelChanges {
    ...
    public static void init() {
        ...
        // STEAM GENERATOR
        ADVANCED_STEAM_FUELS.recipeBuilder()
        ...
        COMBUSTION_GENERATOR_FUELS.recipeBuilder()
                .fluidInputs(Hydrogen.getFluid(4))
                .duration(8)
                .EUt((int) V[LV])
                .buildAndRegister();

        ADVANCED_COMBUSTION_FUELS.recipeBuilder()
        ...
        COMBUSTION_GENERATOR_FUELS.recipeBuilder()
                .fluidInputs(SulfuricGas.getFluid(2))
                .duration(17)
                .EUt((int) V[LV])
                .buildAndRegister();
        ...
        COMBUSTION_GENERATOR_FUELS.recipeBuilder()
                .fluidInputs(Methanol.getFluid(2))
                .duration(21)
                .EUt((int) V[LV])
                .buildAndRegister();
        ...
        COMBUSTION_GENERATOR_FUELS.recipeBuilder()
                .fluidInputs(RefineryGas.getFluid(2))
                .duration(36)
                .EUt((int) V[LV])
                .buildAndRegister();
        ...
        COMBUSTION_GENERATOR_FUELS.recipeBuilder()
                .fluidInputs(Butadiene.getFluid(2))
                .duration(76)
                .EUt((int) V[LV])
                .buildAndRegister();
        ...
        COMBUSTION_GENERATOR_FUELS.recipeBuilder()
                .fluidInputs(Propene.getFluid(2))
                .duration(87)
                .EUt((int) V[LV])
                .buildAndRegister();
        ...
        COMBUSTION_GENERATOR_FUELS.recipeBuilder()
                .fluidInputs(Benzene.getFluid(2))
                .duration(104)
                .EUt((int) V[LV])
                .buildAndRegister();
        ...
        COMBUSTION_GENERATOR_FUELS.recipeBuilder()
                .fluidInputs(SulfuricNaphtha.getFluid(1))
                .duration(136)
                .EUt((int) V[LV])
                .buildAndRegister();
        ...
        COMBUSTION_GENERATOR_FUELS.recipeBuilder()
                .fluidInputs(Nitrobenzene.getFluid(4))
                .duration(198)
                .EUt((int) V[LV])
                .buildAndRegister();
        ...
        COMBUSTION_GENERATOR_FUELS.recipeBuilder()
                .fluidInputs(BioDiesel.getFluid(2))
                .duration(212)
                .EUt((int) V[LV])
                .buildAndRegister();
        ...
        COMBUSTION_GENERATOR_FUELS.recipeBuilder()
                .fluidInputs(HighOctaneGasoline.getFluid(2))
                .duration(359)
                .EUt((int) V[LV])
                .buildAndRegister();
